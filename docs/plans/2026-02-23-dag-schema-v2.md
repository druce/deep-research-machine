...
Run: `cd /Users/drucev/projects/sra3 && uv add --dev pytest`
...
Run: `cd /Users/drucev/projects/sra3 && uv run pytest tests/ -v`
...
Run: `cd /Users/drucev/projects/sra3 && uv run pytest tests/test_schema.py -v`
...
Run: `cd /Users/drucev/projects/sra3 && uv run pytest tests/test_schema.py -v -x`
...
Run: `cd /Users/drucev/projects/sra3 && uv run pytest tests/test_schema.py::test_validate_dag_valid -v -x`
...
Run: `cd /Users/drucev/projects/sra3 && uv run pytest tests/test_schema.py::test_load_dag_substitutes_variables -v -x`
...
Run: `cd /Users/drucev/projects/sra3 && uv run pytest tests/test_schema.py::test_sra_yaml_validates -v`
Expected: PASS
...
Run: `cd /Users/drucev/projects/sra3 && uv run pytest tests/test_schema.py::test_db_init_with_v2_yaml -v`
...
Run: `cd /Users/drucev/projects/sra3 && uv run pytest tests/test_schema.py::test_db_validate_command_valid -v -x`
